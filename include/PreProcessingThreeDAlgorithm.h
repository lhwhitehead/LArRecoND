/**
 *  @file   larpandoracontent/LArControlFlow/PreProcessingThreeDAlgorithm.h
 *
 *  @brief  Header file for the pre processing algorithm class.
 *
 *  $Log: $
 */
#ifndef LAR_PRE_PROCESSING_THREE_D_ALGORITHM_H
#define LAR_PRE_PROCESSING_THREE_D_ALGORITHM_H 1
...
/**
 *  @brief  PreProcessingThreeDAlgorithm class
 */
class PreProcessingThreeDAlgorithm : public pandora::Algorithm
{
public:
    /**
     *  @brief  Default constructor
     */
    PreProcessingThreeDAlgorithm();
